...
public class NewTours_USerRegistration extends BaseTest {
		...
		{
			FileInputStream file =new FileInputStream("E:\\LIVE TECH\\SeleniumTesting\\src\\excelOperations\\NewTours_UserRegister.xlsx");
			...
			for(int i=1;i<=rowCount;i++) {
				...
				FileOutputStream file1 =new FileOutputStream("E:\\LIVE TECH\\SeleniumTesting\\src\\com\\ResultFiles\\NewToursUserRegistration.xlsx");
